...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropDesc: 'عرض رسم بياني زخرفي خلف المحادثة.',
      wallpaperImage: 'صورة',
      wallpaperHermes: 'هيرميس (الافتراضي)',
      wallpaperCustom: 'مخصص',
      wallpaperChoose: 'اختر صورة',
      wallpaperChooseDialog: 'اختر خلفية',
      wallpaperClear: 'مسح',
      wallpaperOpacity: 'الشفافية',
      wallpaperDim: 'تعتيم',
      wallpaperDimDesc: 'تعتيم الشاشة',
      wallpaperBlur: 'ضبابية',
      wallpaperFit: 'ملاءمة',
      wallpaperFill: 'ملء',
      wallpaperFitLabel: 'احتواء',
      wallpaperPosition: 'موضع',
      wallpaperTop: 'أعلى',
      wallpaperCenter: 'وسط',
      wallpaperBottom: 'أسفل',
