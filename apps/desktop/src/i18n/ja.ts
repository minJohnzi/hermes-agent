...
export const ja = defineLocale({
  ...
  settings: {
    ...
    translucencyScope: {
      ...
      backdropDesc: '会話スレッドの背後に装飾グラフィックを表示します。',
      wallpaperImage: '画像',
      wallpaperHermes: 'デフォルト (Hermes)',
      wallpaperCustom: 'カスタム',
      wallpaperChoose: '画像を選択',
      wallpaperChooseDialog: '壁紙を選択',
      wallpaperClear: 'クリア',
      wallpaperOpacity: '不透明度',
      wallpaperDim: '暗さ',
      wallpaperDimDesc: 'オーバーレイの暗さ',
      wallpaperBlur: 'ぼかし',
      wallpaperFit: 'フィット',
      wallpaperFill: '塗りつぶし',
      wallpaperFitLabel: 'フィット',
      wallpaperPosition: '位置',
      wallpaperTop: '上',
      wallpaperCenter: '中央',
      wallpaperBottom: '下',
