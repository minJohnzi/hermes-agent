...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropDesc: 'Show a decorative graphic behind the conversation thread.',
      wallpaperImage: 'Image',
      wallpaperHermes: 'Hermes',
      wallpaperCustom: 'Custom',
      wallpaperChoose: 'Choose image',
      wallpaperChooseDialog: 'Choose Wallpaper',
      wallpaperClear: 'Clear',
      wallpaperOpacity: 'Opacity',
      wallpaperDim: 'Dim',
      wallpaperDimDesc: 'Dim overlay',
      wallpaperBlur: 'Blur',
      wallpaperFit: 'Fit',
      wallpaperFill: 'Fill',
      wallpaperFitLabel: 'Fit',
      wallpaperPosition: 'Position',
      wallpaperTop: 'Top',
      wallpaperCenter: 'Center',
      wallpaperBottom: 'Bottom',
